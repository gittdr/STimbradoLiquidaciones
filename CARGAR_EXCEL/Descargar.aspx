<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Descargar.aspx.cs" Inherits="CARGAR_EXCEL.Descargar" %>
         ...
         <div class="container-fluid mt-4">
                 <div class="card">
                  <div class="card-header">
                    <b>Descargar archivo de nomina</b>
                  </div>
                  <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-row">
                               ...
                               <%-- <div class="form-group col-sm-12" id="bn1" runat="server">
                                  ...
                                  <asp:Button ID="Button1" runat="server" Text="Descargar" CssClass="btn btn-block btn-success mt-4" OnClick="ExportNomina" />
                                </div>--%>
                                 <div class="form-group col-sm-12 mt-4" style="text-align:center" id="Div1" runat="server">

                                  <asp:Button ID="Button2" runat="server" Text="Inicio" CssClass="btn  btn-primary mt-4" OnClick="Inicio" />
                                </div>
